...
def train(stream_train, stream_test, stream_train_eval):
    ...
    if not FLAGS.Apply_HDML:
        ...
        with tf.name_scope('Loss'):
            ...
            J_m = Loss_ops.Loss(embedding_z, label, FLAGS.LossType)  # 加入正则项防止过拟合
        ...
        embedding_zq_negtile, embedding_yp, embedding_yq = inference(x_raw, Javg, is_Training)
        # 定义损失函数、学习率、训练过程
        ...
        with tf.name_scope('Loss'):
            ...
            # J_syn = (1. - tf.exp(-FLAGS.beta / Jgen)) * J_syn
