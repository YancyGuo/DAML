...
tf.flags.DEFINE_string('path', './datasets/data/prostate/5_folds/prostate_2_class_split4.hdf5', '数据地址')
...
tf.flags.DEFINE_string('LossType', 'NpairLoss', 'The type of Loss to be used in training')  # easy_pos_hard_negLoss
