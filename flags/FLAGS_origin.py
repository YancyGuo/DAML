...
tf.flags.DEFINE_string('LossType', 'Triplet', 'The type of Loss to be used in training')  # NpairLoss
...
tf.flags.DEFINE_integer('batch_size', 120, 'batch size, 128 is recommended for cars196')
...
tf.flags.DEFINE_float('embedding_size', 512,
