...
tf.flags.DEFINE_string('LossType', 'easy_pos_hard_negLoss', 'The type of Loss to be used in training')  # easy_pos_hard_negLoss
...
tf.flags.DEFINE_integer('batch_size', 32, 'batch size, 128 is recommended for cars196')  # 18 npaire时设为40出现nan
...
tf.flags.DEFINE_float('embedding_size', 32,    # 512 效果不好
...
tf.flags.DEFINE_bool('Apply_Augmentation', False, '是否应用图像增强')
