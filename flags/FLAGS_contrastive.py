...
tf.flags.DEFINE_string('LossType', 'Contrastive_Loss', 'The type of Loss to be used in training')  # easy_pos_hard_negLoss
#easy_pos_hard_negLoss
tf.flags.DEFINE_string('method', 'pair', '采样策略')  # easy_positive_hard_negatisve
